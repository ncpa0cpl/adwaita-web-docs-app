...
var Ss = b((Uf, Vi) => {
  ...
  })("versions", []).push({version: "3.22.2", mode: ql ? "pure" : "global", copyright: "© 2014-2022 Denis Pushkarev (zloirock.ru)", license: "https://github.com/zloirock/core-js/blob/v3.22.2/LICENSE", source: "https://github.com/zloirock/core-js"});
});
var ws = b((_f, Hi) => {
...
pn();
var Dp = $s(), Fp = An(), Lp = Ft(), Op = ws(), Bp = Ut(), Mp = Mn();
...
var rr = Object.defineProperty, Rp = Object.getOwnPropertyDescriptor, ir = Object.getOwnPropertyNames, jp = Object.prototype.hasOwnProperty, zn = (h, u) => function() {
  ...
  return h;
}, _p = (h) => Up(rr({}, "__esModule", {value: true}), h), H = zn({"<define:process>"() {
}}), zp = W({"src/utils/try-combinations.js"(h, u) {
  H();
  function p() {
    let d;
  ...
  u.exports = p;
}}), Kn = W({"src/language-js/utils/get-shebang.js"(h, u) {
  H();
  function p(d) {
    if (!d.startsWith("#!"))
      return "";
...
`);
  ...
  u.exports = p;
}}), Kp = W({"src/utils/text/skip-inline-comment.js"(h, u) {
  H();
  function p(d, m) {
    if (m === false)
      return false;
  ...
  u.exports = p;
}}), Vp = W({"src/utils/text/skip-newline.js"(h, u) {
  H();
  function p(d, m, x) {
    let A = x && x.backwards;
    if (m === false)
...
` || g === "\r" || g === "\u2028" || g === "\u2029")
  ...
  u.exports = p;
}}), Vn = W({"src/utils/text/skip.js"(h, u) {
  H();
  function p(g) {
    return (E, F, D) => {
      let C = D && D.backwards;
...
}}), Hp = W({"src/utils/text/skip-trailing-comment.js"(h, u) {
  H();
  ...
  u.exports = d;
}}), Wp = W({"src/utils/text/get-next-non-space-non-comment-character-index-with-start-index.js"(h, u) {
  H();
...
var zt, tr, sr, ro, Jp = zn({"node-modules-polyfills:os"() {
  H(), tr = er, sr = `
...
}}), Yp = W({"node-modules-polyfills-commonjs:os"(h, u) {
  H();
  var p = (Jp(), _p(Hn));
  if (p && p.default) {
    u.exports = p.default;
    ...
    p && (u.exports = p);
}}), $p = W({"node_modules/detect-newline/index.js"(h, u) {
  H();
  var p = (d) => {
    if (typeof d != "string")
...
`;
}}), Qp = W({"node_modules/jest-docblock/build/index.js"(h) {
  ...
  function Z(l) {
    ...
    let Q = Object.create(null), Ce = l.replace(D, "").replace(E, "").trimRight(), ee;
    for (; ee = D.exec(l); ) {
...
}}), Zp = W({"src/common/end-of-line.js"(h, u) {
  H();
  function p(A) {
    let g = A.indexOf("\r");
...
}}), ef = W({"src/language-js/pragma.js"(h, u) {
  H();
...
`) + Z;
...
}}), io = W({"src/utils/is-non-empty-array.js"(h, u) {
  H();
  function p(d) {
    return Array.isArray(d) && d.length > 0;
  }
  u.exports = p;
}}), ao = W({"src/language-js/loc.js"(h, u) {
  H();
  var p = io();
  function d(E, F) {
...
}}), no = W({"src/language-js/parse/utils/create-parser.js"(h, u) {
  H();
  ...
  u.exports = x;
}}), ar = W({"src/common/parser-create-error.js"(h, u) {
  H();
  function p(d, m) {
  ...
  u.exports = p;
}}), oo = W({"src/language-js/parse/utils/create-babel-parse-error.js"(h, u) {
  H();
  var p = ar();
  function d(m) {
  ...
  u.exports = d;
}}), tf = W({"src/language-js/utils/is-ts-keyword-type.js"(h, u) {
  H();
  function p(d) {
    let {type: m} = d;
  ...
  u.exports = p;
}}), sf = W({"src/language-js/utils/is-block-comment.js"(h, u) {
  H();
  var p = new Set(["Block", "CommentBlock", "MultiLine"]), d = (m) => p.has(m == null ? void 0 : m.type);
  u.exports = d;
}}), rf = W({"src/language-js/utils/is-type-cast-comment.js"(h, u) {
  H();
  var p = sf();
  function d(m) {
  ...
  u.exports = d;
}}), af = W({"src/utils/get-last.js"(h, u) {
  H();
  var p = (d) => d[d.length - 1];
  u.exports = p;
}}), ho = W({"src/language-js/parse/postprocess/visit-node.js"(h, u) {
  H();
  function p(d, m) {
    if (Array.isArray(d)) {
  ...
  u.exports = p;
}}), lo = W({"src/language-js/parse/postprocess/throw-syntax-error.js"(h, u) {
  H();
  var p = ar();
  function d(m, x) {
  ...
  u.exports = d;
}}), nf = W({"src/language-js/parse/postprocess/typescript.js"(h, u) {
  H();
  var p = ho(), d = lo();
  function m(g, E, F) {
    let D = g.decorators;
...
}}), of = W({"src/language-js/parse/postprocess/index.js"(h, u) {
  H();
  ...
  u.exports = D;
}}), uo = W({"node_modules/@babel/parser/lib/index.js"(h) {
  ...
  var Fo = new Set(["break", "case", "catch", "continue", "debugger", "default", "do", "else", "finally", "for", "function", "if", "return", "switch", "throw", "try", "var", "const", "while", "with", "new", "this", "super", "class", "extends", "export", "import", "null", "true", "false", "in", "instanceof", "typeof", "void", "delete", "implements", "interface", "let", "package", "private", "protected", "public", "static", "yield", "eval", "arguments", "enum", "await"]);
  function Lo(t) {
    return Fo.has(t);
  }
  ...
  var Cr = class {
    ...
    return e >= 48 && e <= 57;
  }, Qo = new Set([103, 109, 115, 105, 121, 117, 100, 118]), vr = {decBinOct: new Set([46, 66, 69, 79, 95, 98, 101, 111]), hex: new Set([46, 88, 95, 120])}, At = {bin: (t) => t === 48 || t === 49, oct: (t) => t >= 48 && t <= 55, dec: (t) => t >= 48 && t <= 57, hex: (t) => t >= 48 && t <= 57 || t >= 65 && t <= 70 || t >= 97 && t <= 102}, we = class {
    constructor(t) {
...
`;
  ...
  var gh = /\*?\s*@((?:no)?flow)\b/, Ah = (t) => class extends t {
    ...
    flowEnumMembers(e) {
      let {enumName: s, explicitType: r} = e, i = new Set(), a = {booleanMembers: [], numberMembers: [], stringMembers: [], defaultedMembers: []}, n = false;
      for (; !this.match(8); ) {
        if (this.eat(21)) {
          n = true;
          break;
...
`), cooked: i === null ? null : i.slice(1, c)}, n.tail = o, this.next(), this.finishNode(n, "TemplateElement"), this.resetEndLocation(n, m(this.state.lastTokEndLoc, c)), n;
    ...
    parseObjectLike(t, e, s, r) {
      ...
      let a = Object.create(null), n = true, o = this.startNode();
    ...
    checkParams(t, e, s) {
      let r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true, i = !e && new Set(), a = {type: "FormalParameters"};
...
}}), hf = W({"src/language-js/parse/json.js"(h, u) {
  H();
  ...
  u.exports = D;
}}), lf = W({"src/language-js/parse/babel.js"(h, u) {
  H();
