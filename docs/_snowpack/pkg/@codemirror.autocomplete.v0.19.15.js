import { Annotation, Text, EditorSelection, StateEffect, Facet, Prec, combineConfig, StateField, MapMode } from '/_snowpack/pkg/@codemirror.state.v0.19.9.js';
import { keymap, EditorView, ViewPlugin, logException, Decoration, WidgetType, Direction } from '/_snowpack/pkg/@codemirror.view.v0.19.48.js';
import { getTooltip, showTooltip } from '/_snowpack/pkg/@codemirror.tooltip.v0.19.16.js';
import { syntaxTree, indentUnit } from '/_snowpack/pkg/@codemirror.language.v0.19.10.js';
import { codePointAt, codePointSize, fromCodePoint } from '/_snowpack/pkg/@codemirror.text.v0.19.6.js';
