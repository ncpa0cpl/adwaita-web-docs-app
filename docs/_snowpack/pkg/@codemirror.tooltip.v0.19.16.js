import { ViewPlugin, Direction, EditorView, logException } from '/_snowpack/pkg/@codemirror.view.v0.19.48.js';
import { Facet, StateEffect, StateField, MapMode } from '/_snowpack/pkg/@codemirror.state.v0.19.9.js';
