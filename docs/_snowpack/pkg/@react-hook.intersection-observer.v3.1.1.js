import '/_snowpack/pkg/intersection-observer.v0.10.0.js';
import { useState, useEffect } from '/_snowpack/pkg/react.v18.2.0.js';
import useLayoutEffect from '/_snowpack/pkg/@react-hook.passive-layout-effect.v1.2.1.js';
...
function useIntersectionObserver(target, options = {}) {
  ...
  const [observer, setObserver] = useState(() => getIntersectionObserver({
    root,
    pollInterval,
    useMutationObserver,
    rootMargin,
