import { MapMode, ChangeSet, EditorSelection, EditorState, Transaction, Prec, StateEffect, Facet, Text as Text$1, CharCategory, combineConfig, StateField } from '/_snowpack/pkg/@codemirror.state.v0.19.9.js';
import { StyleModule } from '/_snowpack/pkg/style-mod.v4.0.0.js';
import { RangeValue, RangeSet, RangeSetBuilder } from '/_snowpack/pkg/@codemirror.rangeset.v0.19.9.js';
export { Range } from '/_snowpack/pkg/@codemirror.rangeset.v0.19.9.js';
import { codePointAt, countColumn, findClusterBreak, findColumn, Text } from '/_snowpack/pkg/@codemirror.text.v0.19.6.js';
import { keyName, base } from '/_snowpack/pkg/w3c-keyname.v2.2.5.js';
