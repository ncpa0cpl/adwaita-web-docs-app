...
export { INDEXEDDB, LOCALSTORAGE, WEBSQL, localforage as __moduleExports, _config, _dbInfo, _defaultConfig, _driverSet, _initDriver, _ready, clear, dropInstance, getItem, iterate, key, keys, length, removeItem, setItem };
