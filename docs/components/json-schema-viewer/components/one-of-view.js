...
const isComplexUnion = (schema) => {
  return schema.oneOf && schema.oneOf.length > 1 && schema.oneOf.some((s) => s.type === "object" || s.type === "array" || Array.isArray(s.type) || s.oneOf || s.allOf);
};
export const OneOfView = ({schema, name, parent}) => {
  ...
  if (!isComplexUnion(schema)) {
    ...
    })), /* @__PURE__ */ React.createElement("td", null, schema.oneOf.map((unionMember, i) => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, name && /* @__PURE__ */ React.createElement(PropertyNameLabel, {
    ...
    description: schema.description
  })), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement(Label, null, "One of:"), /* @__PURE__ */ React.createElement("table", null, /* @__PURE__ */ React.createElement("colgroup", null, /* @__PURE__ */ React.createElement("col", {
    className: "description-column"
  }), /* @__PURE__ */ React.createElement("col", {
    className: "type-column"
  })), /* @__PURE__ */ React.createElement("tbody", null, !isReq && /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("td", null), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement(TypeNameLabel, {
    name: "undefined"
  }))), schema.oneOf.map((unionMember, i) => /* @__PURE__ */ React.createElement("tr", {
    key: i
