import prettier from "../_snowpack/pkg/prettier.v2.7.1.js";
import parserBabel from "../_snowpack/pkg/prettier.esm.parser-babel.v2.7.1.js";
...
function DocTable({classes, data}) {
  ...
  }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", null, "Name"), /* @__PURE__ */ React.createElement("th", null, "Type"), /* @__PURE__ */ React.createElement("th", null, "Required"), /* @__PURE__ */ React.createElement("th", null, "Description"), /* @__PURE__ */ React.createElement("th", null, "Default"))), /* @__PURE__ */ React.createElement("tbody", null, keys.map((key) => /* @__PURE__ */ React.createElement("tr", {
    key
  }, /* @__PURE__ */ React.createElement("td", null, key), /* @__PURE__ */ React.createElement("td", null, formatType(propTypes[key].value)), /* @__PURE__ */ React.createElement("td", null, propTypes[key].required ? "Yes" : null), /* @__PURE__ */ React.createElement("td", null, propTypes[key].description || DEFAULT_PROP_DESCRIPTIONS[key]), /* @__PURE__ */ React.createElement("td", null, formatDefault(defaultProps[key]?.value))))));
}
