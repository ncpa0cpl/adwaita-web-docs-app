...
function Home({ classes }) {
  return (
    <Content className={classes.root}>
      <h1 className={classes.title}>web-toolkit</h1>
      <Text hero>
      ...
      <Text size="large" as="div">
        ...
        <Box horizontal>
          <Box className={classes.card}>
            ...
            <ul>
              <li>
                <Link to="/component/box" className="link">
                  Box
                </Link>
              </li>
              <li>
                <Link to="/component/paned" className="link">
                  Paned
                </Link>
              </li>
              <li>
                <Link to="/component/frame" className="link">
                  Frame
                </Link>
              </li>
            </ul>
          ...
          <Box className={classes.card}>
            ...
            <ul>
              <li>
                <Link to="/component/button" className="link">
                  Button
                </Link>
              </li>
              <li>
                <Link to="/component/input" className="link">
                  Input
                </Link>
              </li>
              <li>
                <Link to="/component/dropdown" className="link">
                  Dropdown
                </Link>
              </li>
              <li>
                <Link to="/component/datepicker" className="link">
                  DatePicker
                </Link>
              </li>
            </ul>
          ...
          <Box className={classes.card}>
            ...
            <ul>
              <li>
                <Link to="/component/icon" className="link">
                  Icon
                </Link>
              </li>
              <li>
                <Link to="/component/label" className="link">
                  Label
                </Link>
              </li>
              <li>
                <Link to="/component/text" className="link">
                  Text
                </Link>
              </li>
            </ul>
